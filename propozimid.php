...
<head>
    ...
    <link rel="stylesheet" href="propozimi.css">
...
<body>
    ...
    <div class="Propozimi">
        <div class="Teksti">
            <h1>PROPOZIM</h1>
            <br> <p align="center">Nëse libri që po e kërkoni nuk gjendet në librarinë tonë, ju mund ta sugjeroni ose ta porositni përmes kësaj faqeje. Ju lutemi plotësoni të dhënat.</p>
        </div>

        <div class="Data">
            <input type="Titulli I Librit" class="form-input" placeholder="Titulli I Librit">
            <input type="Autori" class="form-input" placeholder="Autori">
            <input type="Botimi" class="form-input-opsional" placeholder="Botimi (Opsional)">
            <input type="Komenti" class="form-input-opsional" placeholder="Komente tjera (Opsional)">
            <button class="Dergo">Dërgo</button>
        </div>
    </div>
